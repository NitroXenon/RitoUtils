...
{
    public abstract class Taric : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Taric";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 44;
        ...
        /// </summary>
        public override double BaseHealth => 619.2;
        ...
        /// </summary>
        public override double BaseHealthRegen => 7.94;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 349.08;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 56;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 2.02; 
        ...
        /// </summary>
        public override double BaseArmor => 25.876;
