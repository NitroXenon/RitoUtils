...
{
    public abstract class Thresh : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Thresh";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 412;
        ...
        /// </summary>
        public override double BaseHealth => 560.52;
        ...
        /// </summary>
        public override double BaseHealthRegen => 6.92;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 273.92;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 44;
        ...
        /// </summary>
        public override double BaseAttackDamage => 47.696;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 2.2;
        ...
        /// </summary>
        public override double AutoAttackRange => 450; 
        #endregion Attacks
        ...
        /// </summary>
        public override double BaseArmor => 16;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 0;
