...
{
    public abstract class Azir : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Azir";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 268;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 350.56;
        ...
        /// </summary>
        public override double AttackDamageLevel => 2.8;
