...
{
    public abstract class Sion : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Sion";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 14;
        ...
        /// </summary>
        public override double BaseHealth => 542.64;
        ...
        /// </summary>
        public override double BaseHealthRegen => 10.18;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 275.6;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 8.005;
        ...
        /// </summary>
        public override double BaseAttackDamage => 59.72;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 4;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 1.3; 
        ...
        /// </summary>
        public override double BaseArmor => 23.04;
