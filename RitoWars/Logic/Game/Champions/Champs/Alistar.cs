...
{
    public abstract class Alistar : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Alistar";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 12;
        ...
        /// </summary>
        public override double BaseHealth => 613.36;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 106;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 278.84;
        ...
        /// </summary>
        public override double BaseAttackDamage => 61.1116;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 3.62;
        ...
        /// </summary>
        public override double BaseArmor => 24.38;
