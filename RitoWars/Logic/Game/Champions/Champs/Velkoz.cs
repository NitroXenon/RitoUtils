...
{
    public abstract class Velkoz : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Velkoz";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 161;
        ...
        /// </summary>
        public override double BaseHealth => 507.68;
        ...
        /// </summary>
        public override double BaseAttackDamage => 54.937875658;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 3.14159265359;
