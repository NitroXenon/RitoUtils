...
{
    public abstract class RekSai : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "RekSai";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 421;
        ...
        /// </summary>
        public override double BaseHealth => 570;
        ...
        /// </summary>
        public override double BaseHealthRegen => 7.34;
        ...
        /// </summary>
        public override double BaseAttackDamage => 55.628;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 3.35;
