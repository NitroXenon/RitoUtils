...
{
    public abstract class MissFortune : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "MissFortune";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 21;
        ...
        /// </summary>
        public override double BaseHealth => 577.8;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 275.84;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 38;
        ...
        /// </summary>
        public override double BaseAttackDamage => 49.54;
        ...
        /// </summary>
        public override double BaseAttackSpeed => 0.656; 

        /// <summary>
        /// The champion's attack speed percent gained for leveling up
        /// </summary>
        public override double AttackSpeedPercent => 3.01; 
