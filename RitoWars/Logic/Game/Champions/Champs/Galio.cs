...
{
    public abstract class Galio : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Galio";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 3;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 319;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 1.2; 
