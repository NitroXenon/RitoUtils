...
{
    public abstract class Sivir : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Sivir";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 15;
        ...
        /// </summary>
        public override double BaseHealthRegen => 5.17;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 8.01;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> regen amount gained for leveling up
        /// </summary>
        public override double SecondaryBarRegenLevel => 0.9;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 1.6; 
        ...
        /// </summary>
        public override double BaseArmor => 22.21;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 3.25;
