...
{
    public abstract class FiddleSticks : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "FiddleSticks";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 9;
        ...
        /// </summary>
        public override double BaseHealthRegen => 5.605;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 350.12;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 59;
        ...
        /// </summary>
        public override double BaseAttackDamage => 48.36;
        ...
        /// </summary>
        public override double AutoAttackRange => 480; 
        #endregion Attacks
        ...
        /// </summary>
        public override double BaseArmor => 20.88;
