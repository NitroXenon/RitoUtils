...
{
    public abstract class Vladimir : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Vladimir";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 8;
        ...
        /// </summary>
        public override double BaseHealth => 542.8;
        ...
        /// </summary>
        public override double BaseHealthRegen => 7.005;
        ...
        /// </summary>
        public override double BaseAttackDamage => 48.04;
