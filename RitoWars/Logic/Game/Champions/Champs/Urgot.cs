...
{
    public abstract class Urgot : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Urgot";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 6;
        ...
        /// </summary>
        public override double BaseHealth => 586.52;
        ...
        /// </summary>
        public override double BaseHealthRegen => 6.505;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 312.4;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 8.59;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> regen amount gained for leveling up
        /// </summary>
        public override double SecondaryBarRegenLevel => 0.65;
        ...
        /// </summary>
        public override double BaseAttackDamage => 52.048;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 3.6;
        ...
        /// </summary>
        public override double AutoAttackRange => 425; 
        #endregion Attacks
        ...
        /// </summary>
        public override double BaseArmor => 24.544;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 3.3;
