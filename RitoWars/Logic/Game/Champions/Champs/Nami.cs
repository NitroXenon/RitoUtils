...
{
    public abstract class Nami : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Nami";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 267;
        ...
        /// </summary>
        public override double BaseHealth => 489.32;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 377.24;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 43;
        ...
        /// </summary>
        public override double BaseAttackDamage => 51.208;
        ...
        /// </summary>
        public override double BaseArmor => 19.72;
