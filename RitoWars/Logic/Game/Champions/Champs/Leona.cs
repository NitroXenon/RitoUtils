...
{
    public abstract class Leona : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Leona";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 89;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.425;
        ...
        /// </summary>
        public override double BaseArmor => 27.208;
