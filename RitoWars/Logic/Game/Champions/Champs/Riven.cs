...
{
    public abstract class Riven : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Riven";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 92;
        ...
        /// </summary>
        public override double BaseHealthRegen => 3.34;
        ...
        /// </summary>
        public override double BaseAttackDamage => 56.04;
