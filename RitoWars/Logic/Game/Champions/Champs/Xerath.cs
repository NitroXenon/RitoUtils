...
{
    public abstract class Xerath : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Xerath";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 101;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 316.96;
