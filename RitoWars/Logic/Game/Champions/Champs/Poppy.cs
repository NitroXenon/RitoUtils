...
{
    public abstract class Poppy : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Poppy";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 78;
        ...
        /// </summary>
        public override double BaseHealth => 559.08;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 81;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 235.4;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 7.155;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 3.35; 
