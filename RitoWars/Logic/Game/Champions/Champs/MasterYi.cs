...
{
    public abstract class MasterYi : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "MasterYi";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 11;
        ...
        /// </summary>
        public override double BaseHealth => 598.56;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 92;

        /// <summary>
        /// The champion's amount of health regen
        /// </summary>
        public override double BaseHealthRegen => 7.59;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 250.56;
