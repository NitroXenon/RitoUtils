...
{
    public abstract class Viktor : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Viktor";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 112;
        ...
        /// </summary>
        public override double BaseHealth => 516.04;
        ...
        /// </summary>
        public override double BaseArmor => 22.72;
