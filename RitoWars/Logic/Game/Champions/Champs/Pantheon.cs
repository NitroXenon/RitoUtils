...
{
    public abstract class Pantheon : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Pantheon";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 80;
        ...
        /// </summary>
        public override double BaseHealth => 579.16;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 267.12;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 34;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> base regen amount
        /// </summary>
        public override double BaseSecondaryBarRegen => 7.355;
        ...
        /// </summary>
        public override double BaseAttackDamage => 55.572;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 2.9;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 2.95; 
        ...
        /// </summary>
        public override double BaseArmor => 27.652;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 3.9;
