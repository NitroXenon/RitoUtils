...
{
    public abstract class Braum : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Braum";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 201;
        ...
        /// </summary>
        public override double BaseHealth => 576.16;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.18;

        /// <summary>
        /// The champion's health regen gained for leveling up
        /// </summary>
        public override double HealthRegenLevel => 1;
        #endregion Health
        ...
        /// </summary>
        public override double BaseArmor => 26.72;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 4.5;
