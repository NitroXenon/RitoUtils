...
{
    public abstract class Nunu : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Nunu";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 20;
        ...
        /// </summary>
        public override double BaseHealth => 598.28;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.39;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 283.56;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 7.44;
        ...
        /// </summary>
        public override double BaseAttackDamage => 56.856;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 3.45;
        ...
        /// </summary>
        public override double BaseArmor => 26.38;
