...
{
    public abstract class Fizz : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Fizz";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 105;
        ...
        /// </summary>
        public override double BaseAttackDamage => 58.04;
        ...
        /// </summary>
        public override double BaseArmor => 22.412;
