...
{
    public abstract class Corki : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Corki";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 42;
        ...
        /// </summary>
        public override double BaseHealth => 512.76;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 305.16;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 37;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> base regen amount
        /// </summary>
        public override double BaseSecondaryBarRegen => 7.42;
        ...
        /// </summary>
        public override double BaseAttackDamage => 51.24;
