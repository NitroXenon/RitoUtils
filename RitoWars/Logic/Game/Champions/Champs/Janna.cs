...
{
    public abstract class Janna : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Janna";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 40;
        ...
        /// </summary>
        public override double BaseHealth => 487.04;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 409.52;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 64;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> base regen amount
        /// </summary>
        public override double BaseSecondaryBarRegen => 9;
        ...
        /// </summary>
        public override double BaseAttackDamage => 51.956;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 2.95;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 2.61; 

        /// <summary>
        /// The champion's auto attack range
        /// </summary>
        public override double AutoAttackRange => 475; 
        #endregion Attacks
        ...
        /// </summary>
        public override double BaseArmor => 19.384;
