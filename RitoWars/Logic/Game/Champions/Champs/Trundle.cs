...
{
    public abstract class Trundle : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Trundle";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 48;
        ...
        /// </summary>
        public override double HealthLevel => 96;

        /// <summary>
        /// The champion's amount of health regen
        /// </summary>
        public override double BaseHealthRegen => 9.425;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 281.6;
        ...
        /// </summary>
        public override double ArmorLevel => 2.7;
