...
{
    public abstract class Tryndamere : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Tryndamere";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 23;
        ...
        /// </summary>
        public override double BaseHealth => 625.64;
        ...
        /// </summary>
        public override double BaseArmor => 24.108;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 3.1;
