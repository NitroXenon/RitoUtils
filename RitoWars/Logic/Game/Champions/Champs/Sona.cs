...
{
    public abstract class Sona : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Sona";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 37;
        ...
        /// </summary>
        public override double BaseHealth => 482.36;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 77;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 340.6;
        ...
        /// </summary>
        public override double BaseAttackDamage => 50.04;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 2.3; 
        ...
        /// </summary>
        public override double BaseArmor => 20.544;
