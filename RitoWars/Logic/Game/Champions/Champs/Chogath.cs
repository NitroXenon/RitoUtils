...
{
    public abstract class Chogath : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Chogath";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 31;
        ...
        /// </summary>
        public override double BaseHealth => 574.4;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.925;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 272.2;
        ...
        /// </summary>
        public override double BaseAttackDamage => 61.156;

        /// <summary>
        /// The champion's attack damage gained for leveling up
        /// </summary>
        public override double AttackDamageLevel => 4.2;
        ...
        /// </summary>
        public override double BaseArmor => 28.88;
