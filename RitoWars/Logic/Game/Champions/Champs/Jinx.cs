...
{
    public abstract class Jinx : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Jinx";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 222;
        ...
        /// </summary>
        public override double BaseHealthRegen => 5.84;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 245.6;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 6.68;
