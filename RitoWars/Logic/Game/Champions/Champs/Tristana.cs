...
{
    public abstract class Tristana : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Tristana";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 18;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 246.76;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 32;
        ...
        /// </summary>
        public override double BaseAttackDamage => 51.54;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 1.5; 
        ...
        /// </summary>
        public override double BaseArmor => 22;
