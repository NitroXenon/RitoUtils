...
{
    public abstract class Warwick : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Warwick";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 19;
        ...
        /// </summary>
        public override double BaseHealth => 592.64;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 98;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 240.4;
        ...
        /// </summary>
        public override double BaseSecondaryBarRegen => 8.105;
        ...
        /// </summary>
        public override double BaseAttackDamage => 62.43;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 2.88; 
