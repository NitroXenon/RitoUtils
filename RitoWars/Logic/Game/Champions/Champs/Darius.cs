...
{
    public abstract class Darius : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Darius";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 122;
        ...
        /// </summary>
        public override double BaseHealth => 582.24;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 100;

        /// <summary>
        /// The champion's amount of health regen
        /// </summary>
        public override double BaseHealthRegen => 9.845;

        /// <summary>
        /// The champion's health regen gained for leveling up
        /// </summary>
        public override double HealthRegenLevel => 0.95;
        #endregion Health
        ...
        /// </summary>
        public override double BaseArmor => 30;
