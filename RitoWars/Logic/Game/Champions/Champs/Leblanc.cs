...
{
    public abstract class Leblanc : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Leblanc";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 7;
        ...
        /// </summary>
        public override double BaseHealthRegen => 7.42;
        ...
        /// </summary>
        public override double BaseAttackDamage => 54.88;
        ...
        /// </summary>
        public override double AttackSpeedPercent => 1.4; 
