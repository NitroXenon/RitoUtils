...
{
    public abstract class Nocturne : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Nocturne";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 56;
        ...
        /// </summary>
        public override double BaseHealth => 582.8;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.26;
        ...
        /// </summary>
        public override double BaseAttackDamage => 59.208;
