...
{
    public abstract class Varus : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Varus";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 110;
        ...
        /// </summary>
        public override double BaseHealth => 537.76;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 310.48;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 36;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> base regen amount
        /// </summary>
        public override double BaseSecondaryBarRegen => 7.34;
        ...
        /// </summary>
        public override double BaseArmor => 23.212;
