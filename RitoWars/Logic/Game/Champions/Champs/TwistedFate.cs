...
{
    public abstract class TwistedFate : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "TwistedFate";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 4;
        ...
        /// </summary>
        public override double BaseHealth => 521.76;
        ...
        /// </summary>
        public override double BaseHealthRegen => 5.505;
        ...
        /// </summary>
        public override double BaseAttackDamage => 49.954;
        ...
        /// </summary>
        public override double BaseArmor => 20.542;

        /// <summary>
        /// The champion's armor gained for leveling up
        /// </summary>
        public override double ArmorLevel => 3.15;
