...
{
    public abstract class Akali : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Akali";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 84;
        ...
        /// </summary>
        public override double BaseHealth => 587.8;
        ...
        /// </summary>
        public override double BaseHealthRegen => 8.34;
        ...
        /// </summary>
        public override double BaseAttackDamage => 58.376;
