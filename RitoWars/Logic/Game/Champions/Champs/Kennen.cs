...
{
    public abstract class Kennen : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Kennen";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 85;
        ...
        /// </summary>
        public override double BaseHealth => 535.72;
        ...
        /// </summary>
        public override double BaseHealthRegen => 5.59;
        ...
        /// </summary>
        public override double BaseAttackDamage => 50.544;
