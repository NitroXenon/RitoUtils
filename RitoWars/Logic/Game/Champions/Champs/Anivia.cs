...
{
    public abstract class Anivia : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Anivia";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 34;
        ...
        /// </summary>
        public override double BaseHealth => 467.6;

        /// <summary>
        /// The champion's health gained for leveling up
        /// </summary>
        public override double HealthLevel => 70;

        /// <summary>
        /// The champion's amount of health regen
        /// </summary>
        public override double BaseHealthRegen => 5.57;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 346.04;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 53;
        ...
        /// </summary>
        public override double BaseAttackDamage => 51.376;
        ...
        /// </summary>
        public override double BaseArmor => 21.22;
