...
{
    public abstract class Draven : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Draven";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 119;
        ...
        /// </summary>
        public override double BaseHealth => 557.76;
        ...
        /// </summary>
        public override double BaseHealthRegen => 6.175;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 310.56;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 42;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> base regen amount
        /// </summary>
        public override double BaseSecondaryBarRegen => 8.04;
        ...
        /// </summary>
        public override double BaseAttackDamage => 50.38;
        ...
        /// </summary>
        public override double BaseArmor => 25.544;
