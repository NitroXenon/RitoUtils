...
{
    public abstract class Karthus : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "Karthus";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 30;
        ...
        /// </summary>
        public override double BaseHealth => 516;
        ...
        /// </summary>
        public override double BaseHealthRegen => 6.42;
        ...
        /// </summary>
        public override double BaseSecondaryBarData => 372.48;

        /// <summary>
        /// The champion's <seealso cref="SecondaryBar"/> amount gained for leveling up
        /// </summary>
        public override double SecondaryBarDataLevel => 61;
        ...
        /// </summary>
        public override double BaseAttackDamage => 45.66;
