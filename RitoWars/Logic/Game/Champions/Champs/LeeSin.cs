...
{
    public abstract class LeeSin : BaseChamp
    {
        #region ChampData
        /// <summary>
        /// The champion name
        /// </summary>
        public override string ChampName => "LeeSin";

        /// <summary>
        /// The champion id
        /// </summary>
        public override int ChampId => 64;
        ...
        /// </summary>
        public override double BaseHealth => 570.8;
        ...
        /// </summary>
        public override double BaseAttackDamage => 61.176;
        ...
        /// </summary>
        public override double BaseArmor => 24.216;
